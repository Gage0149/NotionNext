...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'AIGC', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '平面设计师，AIGC爱好者', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.wyfing.top/', // 网站地址
